...
export const meta = {
  ...
  published: true,
  description: 'WebAssembly, abreviado conocido como WASM, es una nueva capacidad para la web. Es un blanco de compilación para lenguajes utilizados en aplicaciones nativas. Es rápido, portable y seguro.',
  lang: 'es',
