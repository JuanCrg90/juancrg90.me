...
export const meta = {
  postImage: 'http://res.cloudinary.com/juancrg90/image/upload/v1434983837/MagmaConf2015/CH5YUCWUMAA3YEV.jpg',
  title: 'Mi primer experiencia MagmaConf',
  slug: 'mi-primer-experiencia-magmaconf',
  date: '2015-06-22T14:06',
  published: true,
  description: 'Los pasados 18,19 y 20 de junio, tuve la oportunidad de asistir por primera vez a la MagmaConf 2015 en la ciudad de Manzanillo, Colima, México.',
  lang: 'es',
  tags: ['MagmaConf 2015', 'MagmaConf', 'Open Source', 'Cylon.js', 'go lang', 'ruby', 'colima', 'manzanillo' ]
}
