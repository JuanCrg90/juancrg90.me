...
export const meta = {
  postImage: 'http://res.cloudinary.com/juancrg90/image/upload/v1422840429/Diciembre%202014/feliz-ano.jpg',
  title: 'Un año que termina',
  slug: 'un-ano-que-termina',
  date: '2014-12-31T21:12',
  published: true,
  description: 'Agradezco a todos los que estuvieron conmigo este año y también a las personas que ya no están. Espero que el próximo año 2015 sea un año lleno de éxito en todos los ámbitos de sus vidas.',
  lang: 'es',
  tags: []
}
