...
export const meta = {
  postImage: 'http://res.cloudinary.com/juancrg90/image/upload/v1450592438/Captura_de_pantalla_de_2015-12-19_12-56-43_rfiw7y.png',
  title: '6 Meses usando Vim',
  slug: '6-meses-programando-en-vim',
  date: '2015-12-26T23:12',
  published: true,
  description: 'Hace 6 meses inicié a utilizar Vim como mi editor de código principal, y decidí escribir esta entrada para platicar un poco de mi experiencia.',
  lang: 'es',
  tags: ['JavaScript', 'Open Source', 'Node.js', 'Vim', 'Code Editors', 'Plugins', 'Programming']
}
