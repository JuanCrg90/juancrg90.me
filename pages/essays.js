...
const essays2016 = [
  { source: 'self', sourceUrl: '/', title: 'Unificando estilos de programación con EditorConfig', slug: 'unificando-estilos-de-programacion-con-editorconfig-2', date: '2016-10-30T08:10' },
]


const essays2015 = [
  { source: 'self', sourceUrl: '/', title: 'Y se fue el 2015', slug: 'y-si-fue-el-2015', date: '2015-12-31T23:12' },
  { source: 'self', sourceUrl: '/', title: '6 Meses usando Vim', slug: '6-meses-programando-en-vim', date: '2015-12-26T23:12' },
  { source: 'self', sourceUrl: '/', title: 'Mi primer experiencia MagmaConf', slug: 'mi-primer-experiencia-magmaconf', date: '2015-06-22T14:06' },
  { source: 'self', sourceUrl: '/', title: 'Emprendimiento 101: ¿Quién es tu cliente?', slug: 'emprendimiento-101-quien-es-tu-cliente', date: '2015-01-11T07:01' },
];
const essays2014 = [
  { source: 'self', sourceUrl: '/', title: 'Un año que termina', slug: 'un-ano-que-termina', date: '2014-12-31T21:12' },
  { source: 'self', sourceUrl: '/', title: 'Meteor un framework de JavaScript para el 2015', slug: 'meteor-un-framework-de-javascript-para-el-2015', date: '2014-12-29T06:12' },
  { source: 'self', sourceUrl: '/', title: 'Hola Mundo', slug: 'hola-mundo', date: '2014-11-15T19:11' },
];
